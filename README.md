## 📌**Overview:**
Weather App is a simple and interactive web application that allows users to get real-time weather information for any city. The app fetches live weather data using OpenWeather API and displays key details like temperature, humidity, and weather conditions in a clean and user-friendly interface. Additionally, users can view news related to the searched city or browse the latest news, with data fetched from News API.
